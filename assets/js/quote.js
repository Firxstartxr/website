...
function displayRandomQuote() {
    ...
    document.getElementById('quote-profession').textContent = randomQuote.profession;
    document.getElementById('quote-topics').textContent = `Topics: ${randomQuote.topics.join(', ')}`;
}
